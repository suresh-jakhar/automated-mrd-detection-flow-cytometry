...
class MRDPredictor:
    ...
    def __init__(self, model_path, scaler_path=None, input_dim=14, latent_dim=4, threshold=0.02310833333333333, device='cpu'):
        """
        ...
        # Initialize model
        self.model = VarAutoEncoder(input_dim=input_dim, latent_dim=latent_dim).to(self.device)
        ...
        if scaler_path and os.path.exists(scaler_path):
            ...
            logger.info("MinMaxScaler initialized. Will be fitted on first batch of data.")
